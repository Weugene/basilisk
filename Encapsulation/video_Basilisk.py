    ...
    if not os.path.exists(place):
        ...
        if os.path.exists(name):
            ...
            if len(segs1) == 0 or len(segs2) == 0:
                ...
                facets1 = np.array([117, 112, 179]) / 255.0
                facets2 = np.array([217, 95, 2]) / 255.0
                ...
                line_segments1 = LineCollection(
                    segs1, linewidths=lw, colors=facets1, linestyle="solid",
                )
                ax.add_collection(line_segments1)
                line_segments2 = LineCollection(
                    segs2, linewidths=lw, colors=facets2, linestyle="solid",
                )
