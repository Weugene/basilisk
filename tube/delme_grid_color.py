...
renderView1.CameraPosition = [-0.04412502678908515, 1.2865902193688248, 5.246089279592857]
renderView1.CameraFocalPoint = [-0.02682073148201014, 1.2812802567333037, 5.225681692586954]
...
renderView1.CameraParallelScale = 0.9302521790526845
...
save_isosurfacepvd = PVDReader(
    registrationName="save_isosurface.pvd",
    FileName="/Users/weugene/basilisk/work/tube/res23/save_isosurface.pvd",
)
...
save_isosurfacepvdDisplay.ScaleTransferFunction.Points = [
...
save_isosurfacepvdDisplay.OpacityTransferFunction.Points = [
    0.005237827916105199,
    0.0,
    0.5,
    0.0,
...
clip1Display.DataAxesGrid.XTitle = "X"
clip1Display.DataAxesGrid.YTitle = "Y"
clip1Display.DataAxesGrid.ZTitle = "Z"
...
clip1Display.DataAxesGrid.GridColor = [0, 0, 0]
