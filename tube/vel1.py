...
tube_bp_from_dumppvd = PVDReader(
    FileName="/Volumes/GoogleDrive/My Drive/Skoltech/Dumps/tube/10e_coarse/tube_bp_from_dump.pvd",
)
...
# save screenshot
SaveScreenshot(
    "/Volumes/GoogleDrive/My Drive/Skoltech/Dumps/tube/10e_coarse/mm1.png",
    renderView1,
...
# save screenshot
SaveScreenshot(
    "/Volumes/GoogleDrive/My Drive/Skoltech/Dumps/tube/10e_coarse/mm2.png",
    renderView1,
    ImageResolution=[2120, 1134],
    TransparentBackground=0,
)
