...
contour0 = Contour(Input=tube_bp_from_dumppvd)
...
bounds = [15, 17, -0.5, 0.5, -0.5, 0.5]


print("bounds=", bounds)

# # calculation of bounds
boundsDomain = tube_bp_from_dumppvd.GetDataInformation().GetBounds()
...
# show data in view
tube_bp_from_dumppvdDisplay = Show(
    tube_bp_from_dumppvd, renderView1, "UnstructuredGridRepresentation",
)
...
tube_bp_from_dumppvdDisplay.OSPRayScaleFunction.Points = [
...
renderView1.ResetCamera(
    15.0, 17.0, -0.427789067491, 0.425649342926, -0.427947942457, 0.427292957237,
)
