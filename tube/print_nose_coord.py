...
if __name__ == "__main__":
    ...
    with open(path + "output_sliced_Rmax_U.json") as f:
        outputs = json.load(f)
    ...
    plot_graph(
        [df["t"].values, df["t"].values, outputs["t"]],
        [df["x_nose"].values, df["x_mean"].values, outputs["x_tip"]],
        ["X nose", "X mean", "X tip"],
    ...
    plot_graph(
        [df["t"].values, df["t"].values, outputs["t"]],
        [np.diff(df["x_nose"].values) / np.diff(df["t"].values), umean_estim, outputs["U_tip"]],
        ["U nose", "U mean", "U tip"],
        dash=["solid", "dot", "dash"],
        xtitle="t",
        ytitle="U",
    ...
    plot_graph(
        [list_t, df["t"].values, outputs["t"]],
        [list_unose, df["UmeanV"].values, outputs["U_tip"]],
        ["U nose", "U mean", "U tip"],
        dash=["solid", "dot", "dash"],
        xtitle="t",
        ytitle="U",
