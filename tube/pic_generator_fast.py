...
parser.add_argument(
    "-lDomain",
    type=float,
    help="Provide the length of the channel",
    nargs="?",
    default=30,
)
parser.add_argument(
    "-uxScale",
    type=float,
    help="Provide the scale of velocity magnitude",
    nargs="?",
    default=None,
)
...
if not noPic:
    for i in timeList:
        try:
            ...
            # init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
            calculator0Display.ScaleTransferFunction.Points = [
                0.005237827916105199,
                0.0,
                0.5,
                0.0,
                0.46907547386229526,
            ...
            # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
            calculator0Display.OpacityTransferFunction.Points = [
                0.005237827916105199,
                0.0,
                0.5,
                0.0,
            ...
            annotateTimeFilter1 = AnnotateTimeFilter(
                registrationName="AnnotateTimeFilter1", Input=my_source,
            )
