...
centerDomain = [
    (boundsDomain[0] + boundsDomain[1]) / 2,
    (boundsDomain[2] + boundsDomain[3]) / 2,
    (boundsDomain[4] + boundsDomain[5]) / 2,
]
...
my_sourceDisplay.OSPRayScaleFunction.Points = [
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
cellDatatoPointData1Display.OSPRayScaleFunction.Points = [
    0.001414213562373095,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
delaunay3D1Display.OSPRayScaleFunction.Points = [
    0.001414213562373095,
    0.0,
    0.5,
    0.0,
