...
save_isosurfacepvd = PVDReader(
    FileName="/home/e.sharaborin/basilisk/work/tube/save_isosurface.pvd",
)
...
print(
    "N=", ss_data.GetNumberOfPoints(), "Area=", area, "rad_dv=", rad_dv, "rad_mean=", rad_dv / area,
)
