...
save_isosurface_tailpvd = PVDReader(
    FileName="/home/e.sharaborin/wbasilisk/tube/res22_adaptffsu_new/dumps/save_isosurface_tail.pvd",
)
save_isosurface_tailpvd.CellArrays = ["vtkGhostType"]
save_isosurface_tailpvd.PointArrays = [
    "u.x",
    "absOmega",
    "f",
    "fs",
...
save_isosurface_tailpvdDisplay = Show(
    save_isosurface_tailpvd, renderView1, "GeometryRepresentation",
)
...
save_isosurface_tailpvdDisplay.ScaleTransferFunction.Points = [
...
save_isosurface_tailpvdDisplay.OpacityTransferFunction.Points = [
    0.005237827916105199,
    0.0,
    0.5,
    0.0,
