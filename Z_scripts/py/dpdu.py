...
calculator3Display.OSPRayScaleFunction.Points = [
...
calculator3Display.ScaleTransferFunction.Points = [
    3.984961880906345e-07,
    0.0,
    0.5,
    0.0,
    0.006474512918947373,
    1.0,
    0.5,
    0.0,
]
...
calculator3Display.OpacityTransferFunction.Points = [
    3.984961880906345e-07,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
calculator4Display.OSPRayScaleFunction.Points = [
    0.001414213562373095,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
calculator4Display.ScaleTransferFunction.Points = [
    0.00034722218441315955,
    0.0,
    0.5,
    0.0,
    35.07826541445242,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
calculator4Display.OpacityTransferFunction.Points = [
    0.00034722218441315955,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
plotOverLine2Display.OSPRayScaleFunction.Points = [
    0.001414213562373095,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
plotOverLine2Display.ScaleTransferFunction.Points = [
    0.026302532885149013,
    0.0,
    0.5,
    0.0,
    35.07826541445235,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
plotOverLine2Display.OpacityTransferFunction.Points = [
    0.026302532885149013,
    0.0,
    0.5,
    0.0,
...
plotOverLine2Display_1.SeriesVisibility = [
    "fs",
    "l",
    "omega",
    "p",
...
plotOverLine2Display_1.SeriesLabel = [
    "arc_length",
    "arc_length",
    "fs",
    "fs",
...
plotOverLine2Display_1.SeriesColor = [
    "arc_length",
    "0",
    "0",
    "0",
...
plotOverLine2Display_1.SeriesPlotCorner = [
    "arc_length",
    "0",
    "fs",
    "0",
...
plotOverLine2Display_1.SeriesLineStyle = [
    "arc_length",
    "1",
    "fs",
    "1",
...
plotOverLine2Display_1.SeriesLineThickness = [
    "arc_length",
    "2",
    "fs",
    "2",
...
plotOverLine2Display_1.SeriesMarkerStyle = [
    "arc_length",
    "0",
    "fs",
    "0",
