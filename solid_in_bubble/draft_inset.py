...
parser.add_argument(
    "-pvdfile",
    type=str,
    help="Provide the name for the pvd file, please",
    nargs="?",
    default="",
)
parser.add_argument(
...
for time in timesteps:
    ...
    resampleToImage = ResampleToImage(
        registrationName="ResampleToImage", Input=cellDatatoPointData,
    )
    ...
    # init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
    contour4Display.ScaleTransferFunction.Points = [
        0.5,
        0.0,
        0.5,
        0.0,
