...
optional.add_argument(
    ...
    nargs="?",
    default="output_res.pvd",
)
optional.add_argument(
    "-frameRate",
    type=int,
    help="Provide the frameRate, please",
    nargs="?",
    default=10,
)
parser.add_argument(
    "-picName",
    type=str,
    help="Provide the name for the output pictures, please",
    nargs="?",
    default="pone",
)
...
optional.add_argument(
    "-fontsize",
    type=int,
    help="Provide the font size argument",
    nargs="?",
    default=32,
)
parser.add_argument(
...
for i in timeList:
    ...
    for feature in ["alpha_doc", "u", "mu_cell", "T"]:
        ...
        annotateTimeFilter1 = AnnotateTimeFilter(
            registrationName="AnnotateTimeFilter1", Input=hyperTreeGridToDualGrid1,
        )
        # ----------------------------------------------------------------
        ...
        hyperTreeGridToDualGrid2Display = GetDisplayProperties(
            hyperTreeGridToDualGrid1, view=renderView1,
        )
