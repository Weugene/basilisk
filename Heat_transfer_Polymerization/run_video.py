...
def sort_names(image_files):
    ...
    times = [re.findall(r"\d+\.\d+", string)[0] for string in file_names]
...
parser.add_argument(
    "-dirPattern",
    type=str,
    help="Provide the pattern of search directory, please",
    nargs="?",
    default="*/",
)
parser.add_argument(
...
parser.add_argument(
    "-time",
    type=float,
    help="Provide the frames per second, please",
    nargs="?",
    default=10,
)
parser.add_argument(
    "-fn",
    type=str,
    help="Provide the pvd file names without extension, please",
    nargs="?",
    default="output_res",
)
