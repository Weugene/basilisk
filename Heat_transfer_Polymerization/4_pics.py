...
output_respvd = PVDReader(
    registrationName="output_res.pvd",
    FileName="/Users/weugene/basilisk/work/Heat_transfer_Polymerization/output_res.pvd",
)

# create a new 'HyperTreeGrid To Dual Grid'
hyperTreeGridToDualGrid2 = HyperTreeGridToDualGrid(
    registrationName="HyperTreeGridToDualGrid2", Input=output_respvd,
)

# create a new 'HyperTreeGrid To Dual Grid'
hyperTreeGridToDualGrid3 = HyperTreeGridToDualGrid(
    registrationName="HyperTreeGridToDualGrid3", Input=output_respvd,
)
...
# create a new 'HyperTreeGrid To Dual Grid'
hyperTreeGridToDualGrid4 = HyperTreeGridToDualGrid(
    registrationName="HyperTreeGridToDualGrid4", Input=output_respvd,
)
...
# create a new 'HyperTreeGrid To Dual Grid'
hyperTreeGridToDualGrid1 = HyperTreeGridToDualGrid(
    registrationName="HyperTreeGridToDualGrid1", Input=output_respvd,
)
...
hyperTreeGridToDualGrid1Display = Show(
    hyperTreeGridToDualGrid1, renderView1, "UnstructuredGridRepresentation",
)
...
hyperTreeGridToDualGrid2Display = Show(
    hyperTreeGridToDualGrid2, renderView1, "UnstructuredGridRepresentation",
)
...
hyperTreeGridToDualGrid3Display = Show(
    hyperTreeGridToDualGrid3, renderView1, "UnstructuredGridRepresentation",
)

# get color transfer function/color map for 'mu_cell'
mu_cellLUT = GetColorTransferFunction("mu_cell")
mu_cellLUT.RGBPoints = [
    0.0,
    0.231373,
    0.298039,
    0.752941,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
contour5Display.OpacityTransferFunction.Points = [
    0.5,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
contour6Display.OpacityTransferFunction.Points = [
    0.5,
    0.0,
    0.5,
    0.0,
...
hyperTreeGridToDualGrid4Display = Show(
    hyperTreeGridToDualGrid4, renderView1, "UnstructuredGridRepresentation",
)
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
contour7Display.OpacityTransferFunction.Points = [
    0.5,
    0.0,
    0.5,
    0.0,
...
# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
contour8Display.OpacityTransferFunction.Points = [
    0.5,
    0.0,
    0.5,
    0.0,
